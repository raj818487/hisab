...
# Feature — Payments & Receipts (backend)

- Controllers: `PaymentsController.cs`, `ReceiptsController.cs`
- Abstractions: `IPaymentService`, `IReceiptService`
- Services: `PaymentService`, `ReceiptService`
- Hard rule: **no payment gateway**; receipt HTML download only
