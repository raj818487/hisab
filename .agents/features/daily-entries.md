...
# Feature — Daily entries (backend)

- Controller: `Controllers/DailyEntriesController.cs`
- Abstractions: `Services/Abstractions/IDailyEntryService.cs`
- Service: `Services/DailyEntryService.cs`
- Model: `Models/DailyEntry.cs`
- Rule: unique `(CustomerId, Date)`
