...
describe('Personal hisab', () => {
  it('carries debt forward, allocates settlements by product, and renders the signed-in workspace', async () => {
    const data = {
      ...
      expenses:[
        {id:1,date:'2026-08-20',title:'Milk',category:'Food & groceries',productId:1,amount:120},
    ...
    const api={personalSession:()=>of({name:'Test account'}),personalData:()=>of(data)};
    await TestBed.configureTestingModule({imports:[PersonalPage],providers:[{provide:ApiService,useValue:api}]}).compileComponents();
    const svc=TestBed.inject(PersonalService);
    await svc.init();svc.month.set('2026-09');
    ...
    svc.product.set(0);
    const fixture=TestBed.createComponent(PersonalPage);fixture.detectChanges();await fixture.whenStable();fixture.detectChanges();
    ...
    fixture.componentInstance.beginPayment(data.expenses[0]);fixture.detectChanges();
